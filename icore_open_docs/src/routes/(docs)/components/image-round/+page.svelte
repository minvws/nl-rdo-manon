<script context="module">
  export const breadcrumb = "Ronde afbeelding";
</script>
...
`}
      ...
      <section id="requirements">
        ...
        <h3>Benodigd</h3>
        <ul>
          <li><code>image/image-round.scss</code></li>
        </ul>

        <h3>Optioneel</h3>
        <ul>
          <li><code>image/image-round-variables.scss</code></li>
        </ul>
      </section>
