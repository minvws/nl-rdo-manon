<script context="module">
  export const breadcrumb = "Gecombineerde velden";
</script>
...
<svelte:head>
  <title>Gecombineerde velden</title>
</svelte:head>
  ...
  <article>
    <div>
      ...
      <section id="examples">
        ...
        <h3>Invoerveld met icoonknop</h3>
...
`}
      ...
      <section id="requirements">
        ...
        <ul>
          ...
          <li><code>form/form-combined-field.scss</code></li>
        </ul>
