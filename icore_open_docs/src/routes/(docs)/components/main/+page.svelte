...
`}
      ...
      <section id="related">
        ...
        <nav aria-label="Gerelateerde pagina's">
          <ul>
            <li><a href="main-test-direct">Direct</a>: Content direct binnen <code>main</code>.</li>
            <li>
              <a href="main-test-div">Div</a>: Content binnen <code>main</code> gegroepeerd in
              <code>div</code>'s.
            </li>
            <li>
