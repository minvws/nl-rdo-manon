<script context="module">
  export const breadcrumb = "Tabeldata over meerdere rijen";
</script>
...
<svelte:head>
  <title>Tabeldata over meerdere rijen</title>
</svelte:head>
      ...
      <section id="introduction">
        ...
        <ol>
          ...
          <li>
            ...
            <code>rowspan="[number]"</code>. Voorbeeld: <code>rowspan="2"</code> op de
            <code>td</code>.
          </li>
        </ol>
      </section>
