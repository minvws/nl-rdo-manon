<script context="module">
  export const breadcrumb = "Spot klein";
</script>
  ...
  <article>
    <div>
      <section id="introduction">
        <h1>Spot klein</h1>
        <p>Kleurenset met twee hoofdkleuren en twee accentkleuren.</p>
...
`}
      ...
      <section id="requirements">
        ...
        <h3>Benodigd</h3>
        <ul>
          <li><code>spot-small.scss</code></li>
        </ul>

        <h3>Optioneel</h3>
        <ul>
          <li><code>spot-small-variables.scss</code></li>
        </ul>
      </section>
