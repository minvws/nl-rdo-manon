...
<svelte:head>
  <title>Kleurselector volledig gevuld</title>
</svelte:head>
      ...
      <section id="introduction">
        ...
        <ol>
          ...
          <li>
            ...
            kleur waarin het selectievak getoond wordt binnen het formulier voordat de gebruiker een
            andere keuze maakt.
          </li>
        </ol>
      </section>
...
`}
      ...
      <section id="requirements">
        ...
        <ul>
          ...
          <li><code>form/form-input-color-filled.scss</code></li>
        </ul>
        ...
        <ul>
          ...
          <li><code>form/form-input-color-filled-variables.scss</code></li>
        </ul>
      </section>
