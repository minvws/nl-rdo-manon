<script context="module">
  export const breadcrumb = "Finn middel";
</script>
  ...
  <article>
    <div>
      <section id="introduction">
        <h1>Finn middel</h1>
        <p>Kleurenset met drie kleuren.</p>
...
`}
      ...
      <section id="requirements">
        ...
        <h3>Benodigd</h3>
        <ul>
          <li><code>finn-medium.scss</code></li>
        </ul>

        <h3>Optioneel</h3>
        <ul>
          <li><code>finn-medium-variables.scss</code></li>
        </ul>
      </section>
