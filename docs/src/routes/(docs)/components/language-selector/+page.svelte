<script context="module">
  export const breadcrumb = "Taalselectie";
</script>
  ...
  <article>
    <div>
      <section id="introduction">
        <h1>Taalselectie</h1>
        <p>Een taalselectie element biedt een verticale keuzelijst die openklapt.</p>
