<script context="module">
  export const breadcrumb = "Layout main contentblok";
</script>
...
<svelte:head>
  <title>Layout main contentblok</title>
</svelte:head>
  ...
  <article>
    <div>
      ...
      <section id="requirement">
        ...
        <h3>Optioneel</h3>
        <ul>
          <li><code>layout-main-content-block-variables.scss</code></li>
