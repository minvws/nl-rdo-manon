<script context="module">
  export const breadcrumb = "Layout vier kolommen";
</script>
...
<svelte:head>
  <title>Layout vier kolommen</title>
</svelte:head>
    ...
    <div>
      ...
      <section id="requirements">
        ...
        <ul>
          ...
          <li><code>layout/layout-column-4.scss</code></li>
          <li><code>layout/layout-column-4-variables.scss</code></li>
        </ul>
      </section>
