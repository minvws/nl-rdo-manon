<script module>
  export const breadcrumb = "Tabel met actieknoppen testpagina";
</script>
...
<svelte:head>
  <title>Tabel met actieknoppen testpagina</title>
</svelte:head>
  ...
  <article id="button-base">
    <div>
      <section id="introduction">
        <h1>Tabel met actieknoppen testpagina</h1>
