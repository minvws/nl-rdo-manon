<script context="module">
  export const breadcrumb = "Finn groot";
</script>
  ...
  <article>
    <div>
      <section id="introduction">
        <h1>Finn groot</h1>
        <p>Kleurenset met vijf kleuren.</p>
        ...
        <ol>
          <li>
            ...
            <ul>
              ...
              <li>
                Vul de variabelen met de gewenste kleuren. Voor meer informatie zie het overzicht
                met <a href="#variables">instelbare variabelen</a>.
              </li>
              <li>
                Pas de kleuren toe waar nodig. De kleuren kunnen op twee manieren toegepast worden.
      ...
      <section id="examples">
        ...
        <h3>Kleurenset voorbeeld</h3>
        <h4>Visueel voorbeeld:</h4>
        <ul class="branding">
          <li><span class="branding-color-1">branding-color-1</span></li>
          <li><span class="branding-color-2">branding-color-2</span></li>
          <li><span class="branding-color-3">branding-color-3</span></li>
          <li><span class="branding-color-4">branding-color-4</span></li>
          <li><span class="branding-color-5">branding-color-5</span></li>
        </ul>
...
:root {
  ...
  /* Branding color 3 */
  --branding-color-3-background-color: LightSeaGreen;
  --branding-color-3-text-color: white;

  /* Branding color 4 */
  --branding-color-4-background-color: MediumVioletRed;
  --branding-color-4-text-color: white;

  /* Branding color 5 */
  --branding-color-5-background-color: SlateBlue;
  --branding-color-5-text-color: white;
}
`}
        />
...
`}
        ...
        <h3>Variabele gebruiken binnen de html op een specifiek element</h3>
        <p class="warning">
          ...
          soms nodig is, is het mogelijk om de huistijlkleuren ook direct in de html te kunnen definiëren
          door middel van classes.
        </p>
        <p>
...
`}
      ...
      <section id="requirements">
        ...
        <h3>Benodigd</h3>
        <ul>
          <li><code>finn-large.scss</code></li>
        </ul>

        <h3>Optioneel</h3>
        <ul>
          <li><code>finn-large-variables.scss</code></li>
        </ul>
      </section>
        ...
        <div class="horizontal-scroll">
          <table class="nowrap">
            ...
            <tbody>
              ...
              <tr>
                <th rowspan="8" scope="rowgroup">branding-color-3</th>
                <td>--branding-color-3</td>
                <td>CSS-variable</td>
                <td rowspan="8" scope="rowgroup">branding-color-3</td>
              </tr>
              ...
              <tr>
                <th rowspan="8" scope="rowgroup">branding-color-4</th>
                <td>--branding-color-4</td>
                <td>CSS-variable</td>
                <td rowspan="8" scope="rowgroup">branding-color-4</td>
              </tr>
              ...
              <tr>
                <th rowspan="8" scope="rowgroup">branding-color-5</th>
                <td>--branding-color-5</td>
                <td>CSS-variable</td>
                <td rowspan="8" scope="rowgroup">branding-color-5</td>
              </tr>
