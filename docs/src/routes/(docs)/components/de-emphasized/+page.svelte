<script context="module">
  export const breadcrumb = "Subtielere weergave";
</script>
...
<svelte:head>
  <title>Subtielere weergave</title>
</svelte:head>
    ...
    <div>
      <section id="introduction">
        ...
        <ol>
          ...
          <li>
            Voeg de class <code>de-emphasized</code> toe aan de gewenste elementen. Voor meer
...
`}
      ...
      <section id="variables">
        ...
        <Code
          ...
          code={`
:root {
  --de-emphasized-font-size: ;
  --de-emphasized-font-weight: ;
  --de-emphasized-line-height: ;
