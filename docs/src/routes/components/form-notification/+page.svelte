<script module>
  export const breadcrumb = "Notificatie binnen formulier";
</script>
...
<svelte:head>
  <title>Notificatie binnen formulier</title>
</svelte:head>
...
<main class="sidemenu" id="main-content" tabindex="-1">
  ...
  <article>
    <section id="introduction">
      ...
      <ul>
        <li>
          Let op: visuele feedback op het invoerveld is op zichzelf onvoldoende om toegankelijkheid
          en een goede gebruikerservaring te waarborgen.
        </li>
        <li>
          Vertel de gebruiker altijd wat de vervolgstappen zijn die zij kunnen nemen om het probleem
          op te lossen of om zelf verder te kunnen.
        </li>
        <li>
          Voeg de class toe met het type melding op het invoerveld om gebruik te maken van visuele
          feedback direct op het invoerveld. Voorbeeld: <code>class="error"</code>.
        </li>
        <li>
          Voeg voor screenreader gebruikers <code>aria-invalid="true"</code> toe aan invoervelden met
          een error. In de HTML-voorbeelden is dit meegenomen.
        </li>
        <li>
          Plaats toelichting met betrekking tot het invullen van velden boven het invoerveld, zodat
          de gebruiker eerst de toelichtig leest en daarna het bijbehorende invoerveld tegenkomt.
          Hierdoor weet de gebruiker hoe het invoerveld ingevuld dient te worden voordat deze
          gepresenteerd wordt. Uitzondering hierop zijn toelichtingsteksten die de gerbruiker zelf
          activeert door middel van de hulpknop. Die teksten worden onder het gekozen invoerveld
          geplaatst zodat de structuur van het formulier en het element waar de gebruiker interactie
          mee heeft zo min mogelijk verspringt.
        </li>
        <li>
          Plaats foutmeldingen altijd onder het invoerveld. Dit zorgt ervoor dat de gebruiker eerst
          te zien krijgt wat de context van de foutmelding is wat het begrijpen van de foutmelding
          toegankelijker maakt.
        </li>
        <li>
          Voor meer informatie over beschikbare notificatie-types en het gebruik zie: <a
            href="notifications">Notificaties</a
          >.
        </li>
      </ul>
    </section>
