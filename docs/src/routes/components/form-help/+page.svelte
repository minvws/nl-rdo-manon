  ...
  <article>
    <section id="introduction">
      ...
      <ul>
        ...
        <li>
          Zonder JavaScript wordt de knop niet toegevoegd en wordt hulptekst getoont zonder deze in
          te klappen. Dit zorgt ervoor dat de hulpteksten ook beschikbaar zijn voor gebruikers
          zonder JavaScript.
        </li>
      </ul>
    </section>
