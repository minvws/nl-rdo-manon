<script module>
  export const breadcrumb = "Titel basisset";
</script>
    ...
    <div>
      ...
      <section id="examples">
        ...
        <ul>
          ...
          <li>heading-xl</li>
          <li>heading-large</li>
          <li>heading-normal</li>
          <li>heading-small</li>
          <li>heading-xs</li>
        </ul>

        <h3>HTML-element stijling ingesteld via CSS voorbeeld</h3>
...
`}
        ...
        <h3>Class gebruiken binnen de HTML</h3>
        <p>
