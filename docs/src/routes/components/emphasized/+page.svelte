<script module>
  export const breadcrumb = "Benadrukte weergave";
</script>
...
<svelte:head>
  <title>Benadrukte weergave</title>
</svelte:head>
    ...
    <div>
      <section id="introduction">
        ...
        <ol>
          ...
          <li>
            Voeg de class <code>emphasized</code> toe aan de gewenste elementen. Voor meer
