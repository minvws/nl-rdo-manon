<script module>
  export const breadcrumb = "Ga direct naar inhoud-knop";
</script>
...
<svelte:head>
  <title>Ga direct naar inhoud-knop</title>
</svelte:head>
...
&lt;/header>
          ...
          <p>Voeg aan het naar toe te springen element de corresponderende <code>id</code> toe.</p>
