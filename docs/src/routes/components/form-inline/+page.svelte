<script module>
  export const breadcrumb = '"inline"-formulier';
</script>
...
<main class="sidemenu" id="main-content" tabindex="-1">
  ...
  <article>
    <section id="introduction">
      ...
      <p>
        In sommige gevallen is er om technische redenen een formulier nodig rondom een knop maar is
        het niet nodig om deze visueel binnen een formulier te plaatsen. Voor die situaties is dit
        voorbeeld geschikt.
      </p>
      ...
      <ol>
        ...
        <li>Voeg <code>class="inline"</code> toe aan het formulier.</li>
      </ol>
    </section>
