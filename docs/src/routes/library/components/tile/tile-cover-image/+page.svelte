<script module>
  export const breadcrumb = "Tegelweergave met cover-afbeelding";
</script>
...
<svelte:head>
  <title>Tegelweergave met cover-afbeelding</title>
</svelte:head>
...
<main class="sidemenu" id="main-content" tabindex="-1">
  ...
  <article>
    <h1 class="page-title">Tegelweergave met cover-afbeelding</h1>
      ...
      <section id="introduction">
        ...
        <ul>
          <li>
            ...
            <a href="{base}/library/components/tile">tegelweergave</a>
          </li>
          <li>
            ...
            <a href="{base}/library/components/image/image-cover">cover-afbeelding</a>
          </li>
        </ul>
      </section>
