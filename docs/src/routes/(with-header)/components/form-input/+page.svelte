<script context="module">
  export const breadcrumb = "Invoerveld";
</script>
  ...
  <article>
    <div>
      <section id="introduction">
        <h1>Invoerveld</h1>
        <p>Invoervelden worden gebruikt voor het vragen van korte informatie.</p>
...
`}
        ...
        <h2>Invoerveld uitgeschakeld</h2>
        <p>Aandachtspunten:</p>
        <ul>
          <li>
